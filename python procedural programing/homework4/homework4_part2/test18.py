...
def sort_by_seadS_percent(books_list):
	################################     1 
	...
	return {"read":[books_list_sort(books_list_read)],"noread":[books_list_sort(books_list_noread)]}

print(sort_by_seadS_percent(books_list))