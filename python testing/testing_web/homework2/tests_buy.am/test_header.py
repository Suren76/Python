...
@allure.story("Test logo main block")
...
class TestLogoMainBlock:
    def test_logo_link(self):
        self.page.link_button("//header/div/div[3]/div[1]/a")
        assert self.page.current_url == "https://buy.am/hy/"

    def support_info_tell_number(self):
        txt = self.page.driver.find_element(By.XPATH, "//header/div/div[3]/div[2]/span[1]").text
        assert txt == "+374 11 311 111"

    def support_info_tell_number_text(self):
        txt = self.page.driver.find_element(By.XPATH, "//header/div/div[3]/div[2]/span[2]").text
...
class TestShopNavigation:
    ...
    def test_navigation_notepad(self):
        self.page.link_button("//header/div/nav/ul/li[3]/a")
    ...
    def test_navigation_cart(self):
        self.page.get()
        self.page.find_element(By.XPATH, "//header/div/nav/ul/li[4]/a")
        button_locat_xpath = "//header/div/nav/ul/li[@class='btn cart--link']"
    ...
    def test_navigation_account(self):
        self.page.find_element(By.XPATH, "//header/div/nav/ul/li[5]/a")
        assert self.page.driver.find_element(By.CLASS_NAME, "navigation--entry entry--account with-slt js--is--dropdown-active")

    def test_navigation_settings(self):
        self.page.find_element(By.XPATH, "//header/div/nav/ul/li[6]/a")
        assert self.page.driver.find_element(By.CLASS_NAME, "navigation--entry entry--shop-settings is-opened")
