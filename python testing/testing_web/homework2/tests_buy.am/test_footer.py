...
class TestFirstBlock:
    def test_new_letters_title(self):
        footer_title = self.page.driver.find_element(By.XPATH, "//footer/div/div/div[1]/div[1]/p").text
    ...
    def test_newsletter_field(self):
        ...
        self.page.link_button("//footer/div/div/div[1]/div[1]/form/button")
        assert self.page.driver.current_url == 'https://buy.am/hy/newsletter'

    def test_logo_link(self):
        self.page.link_button("//footer/div/div/div[1]/div[2]/a")
        assert self.page.driver.current_url == "https://buy.am/hy/"

    def test_footer_copyright(self):
        self.page.get()
        txt = self.page.driver.find_element(By.XPATH, "//footer/div/div/div[1]/div[2]/p").text
        assert txt == " \
...
class TestAssocatationsBlock:
    def test_fb(self):
        self.page.link_button("//footer/div/div/div[3]/div/ul[1]/li[1]/a")
        assert self.page.driver.current_url == 'https://www.facebook.com/BuyamOnlineMall/'

    def test_instagram(self):
        self.page.link_button("//footer/div/div/div[3]/div/ul[1]/li[2]/a")
        assert self.page.driver.current_url == 'https://www.instagram.com/buy.am_onlinemall/'

    def test_youtube(self):
        self.page.link_button("//footer/div/div/div[3]/div/ul[1]/li[3]/a")
        assert self.page.driver.current_url == 'https://www.youtube.com/user/buyamofficial'

    def test_visa(self):
        txt = self.page.driver.find_element(By.XPATH, "//footer/div/div/div[3]/div/ul[2]/li[1]").text
        assert txt == "visa"

    def test_master(self):
        txt = self.page.driver.find_element(By.XPATH, "//footer/div/div/div[3]/div/ul[2]/li[2]").text
        assert txt == "master"

    def test_arca(self):
        txt = self.page.driver.find_element(By.XPATH, "//footer/div/div/div[3]/div/ul[2]/li[3]").text
        assert txt == "arca"

    def test_idram(self):
        txt = self.page.driver.find_element(By.XPATH, "//footer/div/div/div[3]/div/ul[3]/li[1]").text
        assert txt == "idram"

    def test_mobidram(self):
        txt = self.page.driver.find_element(By.XPATH, "//footer/div/div/div[3]/div/ul[3]/li[2]").text
        assert txt == "mobidram"

    def test_payx(self):
        txt = self.page.driver.find_element(By.XPATH, "//footer/div/div/div[3]/div/ul[3]/li[3]").text
        assert txt == "payx"

    def test_google_play(self):
        self.page.link_button("//footer/div/div/div[3]/div/ul[4]/li[1]/a")
    ...
    def test_app_store(self):
        self.page.link_button("//footer/div/div/div[3]/div/ul[4]/li[2]/a")
