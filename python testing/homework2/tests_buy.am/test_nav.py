...
class TestNavigationBlock:
    ...
    def test_menuitems_hover(self):
        ...
        hover(elm_1).perform()
        parm_1 = "/html/body/div[1]/nav/div/div[1]/ul/li[1][@class='navigation--entry js--menu-scroller--item is--hovered']"
        ...
        hover(elm_2).perform()
        parm_1 = "/html/body/div[1]/nav/div/div[1]/ul/li[2][@class='navigation--entry js--menu-scroller--item is--hovered']"
        ...
        hover(elm_3).perform()
        parm_1 = "/html/body/div[1]/nav/div/div[1]/ul/li[3][@class='navigation--entry js--menu-scroller--item is--hovered']"
