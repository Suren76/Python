...
class TestShopNavigation:
    ...
    def test_navigation_notepad(self):
        ...
        assert WebDriverWait(self.page.driver,5).until(EC.presence_of_element_located(By.XPATH , button_locat_xpath),'no element')

    def test_navigation_notepad(self):
        self.page.find_element(By.XPATH, "/html/body/div[1]/header/div/nav/ul/li[5]/a")
        assert self.page.driver.find_element(By.XPATH, "/html/body/div[1]/header/div/nav/ul/li[@class='navigation--entry entry--account with-slt js--is--dropdown-active']")

    def test_navigation_notepad(self):
        self.page.find_element(By.XPATH, "/html/body/div[1]/header/div/nav/ul/li[6]/a")
        assert self.page.driver.find_element(By.XPATH, "/html/body/div[1]/header/div/nav/ul/li[@class='navigation--entry entry--shop-settings is-opened']")
...
class TestSearchContainer:
    ...
    def test_search_category(self):
        ...
        assert self.page.driver.find_element(By.XPATH, '//*[@id="searchCategorySelectionBox"]/div[2]/ul[@class="categories-list is-opened"]')

        assert self.page.driver.find_element(By.XPATH, '//*[@id="searchCategorySelectionBox"]/div[2]/ul/li[2]').text == "Բոլորը"
        assert self.page.driver.find_element(By.XPATH, '//*[@id="searchCategorySelectionBox"]/div[2]/ul/li[3]').text == "Քարֆուր"
        assert self.page.driver.find_element(By.XPATH, '//*[@id="searchCategorySelectionBox"]/div[2]/ul/li[1]').text == "Ֆուդկորտ"
        assert self.page.driver.find_element(By.XPATH, '//*[@id="searchCategorySelectionBox"]/div[2]/ul/li[4]').text == "Խանութներ"
        
    def test_search(self):
        self.page.get()

        self.page.search('hot dog')
        assert self.page_result.phrase_result_count(PHRASE) > 0
